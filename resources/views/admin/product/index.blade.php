...
@section("content")
    <div id="content" class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div class="analytic">
                    <a href="" class="text-primary">Đang hoạt động<span class="text-muted">(10)</span></a>
                    <a href="" class="text-danger">Vô hiệu hóa<span class="text-muted">(5)</span></a>
                </div>
                ...
                <table class="table table-striped table-checkall">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="check_item[]" class="checkItem">
                            </td>
                            <td>2</td>
                            <td><img src="http://via.placeholder.com/80X80" alt=""></td>
